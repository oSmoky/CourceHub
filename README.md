...
CourseHub is a Flask and PostgreSQL prototype for an online course platform. It supports admin, instructor, and student roles, course and lesson CRUD, student enrollment, lesson completion tracking, and a Telegram bot/WebView.
...
The full demo account list is in `docs/demo_data.md`. The seed script creates
5 instructors, 15 students, 8 realistic courses, lessons with durations,
enrollments, and sample progress records.

Admin panel:

- `/admin/` - manage users, courses, lessons, and enrollments.
- Admins can create/edit/delete users, assign roles, edit any course, add lessons,
  and update enrollment statuses.
